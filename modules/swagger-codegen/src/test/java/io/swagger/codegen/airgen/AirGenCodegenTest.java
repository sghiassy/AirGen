...
public class AirGenCodegenTest {

    AirGenCodegen swiftCodegen = new AirGenCodegen();
    ...
    public void binaryDataTest() {
        ...
        final DefaultCodegen codegen = new AirGenCodegen();
    ...
    public void testDefaultPodAuthors() throws Exception {
        ...
        // Then
        final String podAuthors = (String) swiftCodegen.additionalProperties().get(AirGenCodegen.POD_AUTHORS);
        Assert.assertEquals(podAuthors, AirGenCodegen.DEFAULT_POD_AUTHORS);
    }
    ...
    public void testPodAuthors() throws Exception {
        ...
        swiftCodegen.additionalProperties().put(AirGenCodegen.POD_AUTHORS, swaggerDevs);
    ...
    public void testInitialConfigValues() throws Exception {
        final AirGenCodegen codegen = new AirGenCodegen();
        codegen.processOpts();
