...
public class AirGenOptionsProvider implements OptionsProvider {
    ...
    public Map<String, String> createOptions() {
        ...
        return builder.put(CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG, SORT_PARAMS_VALUE)
                ...
                .put(AirGenCodegen.PROJECT_NAME, PROJECT_NAME_VALUE).put(AirGenCodegen.RESPONSE_AS, RESPONSE_AS_VALUE)
                .put(AirGenCodegen.UNWRAP_REQUIRED, UNWRAP_REQUIRED_VALUE)
                .put(AirGenCodegen.OBJC_COMPATIBLE, OBJC_COMPATIBLE_VALUE)
                .put(AirGenCodegen.LENIENT_TYPE_CAST, LENIENT_TYPE_CAST_VALUE)
                .put(AirGenCodegen.POD_SOURCE, POD_SOURCE_VALUE).put(CodegenConstants.POD_VERSION, POD_VERSION_VALUE)
                .put(AirGenCodegen.POD_AUTHORS, POD_AUTHORS_VALUE)
                .put(AirGenCodegen.POD_SOCIAL_MEDIA_URL, POD_SOCIAL_MEDIA_URL_VALUE)
                .put(AirGenCodegen.POD_DOCSET_URL, POD_DOCSET_URL_VALUE)
                .put(AirGenCodegen.POD_LICENSE, POD_LICENSE_VALUE).put(AirGenCodegen.POD_HOMEPAGE, POD_HOMEPAGE_VALUE)
                .put(AirGenCodegen.POD_SUMMARY, POD_SUMMARY_VALUE)
                .put(AirGenCodegen.POD_DESCRIPTION, POD_DESCRIPTION_VALUE)
                .put(AirGenCodegen.POD_SCREENSHOTS, POD_SCREENSHOTS_VALUE)
                .put(AirGenCodegen.POD_DOCUMENTATION_URL, POD_DOCUMENTATION_URL_VALUE)
                .put(AirGenCodegen.SWIFT_USE_API_NAMESPACE, SWIFT_USE_API_NAMESPACE_VALUE)
