...
public class AirGenModelTest {

    @Test(description = "convert a simple java model")
    public void simpleModelTest() {
        Assert.assertEquals(true, true);
        // final Model model = new ModelImpl().description("a sample
        // model").property("id", new LongProperty())
        // .property("name", new StringProperty()).property("createdAt", new
        // DateTimeProperty())
        // .property("binary", new BinaryProperty()).property("byte", new
        // ByteArrayProperty())
        // .property("uuid", new UUIDProperty()).property("dateOfBirth", new
        // DateProperty()).required("id")
